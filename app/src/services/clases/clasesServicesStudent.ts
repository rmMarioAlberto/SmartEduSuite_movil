...
export const getClaseActualStudent = async (idUsuario: number) => {
    try {
        ...
        const response = await fetch('https://smar-edu-suite-backend.vercel.app/movil/claseActualStudent', {
            method: 'POST',
            headers: {
...
export const getHorarioTeacher = async (idUsuario: number) => {
    try {
        ...
        const response = await fetch('https://smar-edu-suite-backend.vercel.app/movil/horarioStudent', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
